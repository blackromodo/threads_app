...
{/* Provides the Image to the profile for the comment */}
                        ...
                        className="relative h-11 w-11">
                            <Image
                                ...
                                alt="Profile image"
                                fill
                                className="cursor-pointer rouded-full"
                            />                            
                        </Link>
...
{/* Provides the user's name for the comment */}
...
{/* Gives the icons for like,reply,repost and share */}
